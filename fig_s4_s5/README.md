analyze_data.R = R script to analyze simulated data (results in sim_data/)
...
fig_s4_s5stats.csv = statistics for the single simulation, data analyzed are in sim_data/, output by analyze_data.R
